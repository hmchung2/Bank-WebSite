...
/* 	window.onload = function(){
		setTimeout(stopAutoFill, 100);
	}

	var stopAutoFill = function(){
	...
	$(document).ready(function() {
		...
		if('${previous_msg}' !=  ""){
			$("#sendingMyMsg").text('${previous_msg}')
		...
		<section class="inner-page">
			<div class="container">
				...
				<main class="form-signin">
					<form action="<%=request.getContextPath() %>/member/signinProcess.do" method="post" style="width:50%; margin: 0px auto" onsubmit="return firstValidate()">
		...
		<!-- 					<input autocomplete="anyrandomstring" name="login_pw" class="form-control" placeholder="비밀번호"
						...
						<div class="form-group" style="width:100%;">
							...
							<button type="submit" class="btn btn-primary btn-block" id="loginbtn" style="width:50%;">
								로그인</button>
							<a id="myMsg" href="" class="btn btn-block btn-twitter" style="float:right;"> <img id="kakaoLog" src="<%=request.getContextPath()%>/assets/img/kakaoLogo.jpg">카카오로 로그인</a>	
